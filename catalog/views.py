...
def catalog(request):
    ...
    num_authors = Author.objects.count()  # The 'all()' is implied.

    #
    num_genres = Genre.objects.count()
    num_of_books_containing_the_word_and = Book.objects.filter(
        title__icontains='and').count()
    ...
    return render(
        ...
        context={
            ...
            'num_of_books_containing_the_word_and': num_of_books_containing_the_word_and,
